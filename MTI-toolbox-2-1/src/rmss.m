function [msys] = rmss(n,m,p,r,Ts)
% <rmss> - Generates a random multilinear state-space model
%
% Input parameter:
...
%       integer of (n+m)/2
%   Ts- discretization time, default is 0, thus a continuous-time
%   multilinear model. 
%
% Output parameter:
%  msys - mss object  
...
if nargin==5
   msys=mss.drmss(n,m,p,r,Ts); 
else    
   msys=mss.rmss(n,m,p,r);
end
