...
%    jacobian(obj,x)
%% Description
% |jacobian(obj,x)| Computes the Jacobian of an explicit multilinear model stored in the CP-decomposed norm-1 format |obj| around an operating point |x|. For further information on the implementation of the algorithm see [1].     
%% Input Arguments 
% |obj|: CPN1 object 
%
...
%%
% You can find an example here <matlab:open("Demo_Jacobian_and_Linearization.mlx") open jacobian example>
%% References
...
%% See also
% <cpn2LinDoc.html cpn2Lin>, <cpn2LinSparseDoc.html cpn2LinSparse>,  <linearizeDoc.html linearize>